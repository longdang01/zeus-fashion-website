<div style="z-index: 99999" class="toast-container position-fixed top-0 end-0 p-3">
  <div id="toastSuccess" class="toast" role="alert" aria-live="assertive" aria-atomic="true">
    ...
    <svg class="bd-placeholder-img rounded me-2" width="20" height="20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" preserveAspectRatio="xMidYMid slice" focusable="false"><rect width="100%" height="100%" fill="#064e3b"></rect></svg>
      <strong class="me-auto"></strong>
      <small></small>
      <button type="button" class="btn-close" data-bs-dismiss="toast" aria-label="Close"></button>
    </div>
    <div class="toast-body" style="color: #064e3b; font-weight: bold">
      Thành công! Bạn đã thực hiện thành công.
    </div>
  </div>
</div>
  ...
  <div id="toastErr" class="toast" role="alert" aria-live="assertive" aria-atomic="true">
    ...
    <div class="toast-body" style="background: #d32929; color: #fff; font-weight: bold">
      <div class="d-flex align-items-center" style="justify-content: space-between;">
        Thất bại! Bạn đã thực hiện không thành công.
