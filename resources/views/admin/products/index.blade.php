...
<div ng-controller="ProductController">
    ...
    <div class="grid columns-12 gap-6 mt-5">
        <div class="intro-y g-col-12 d-flex flex-wrap flex-sm-nowrap align-items-center mt-2">
            ...
            <div class="w-full w-sm-auto mt-3 mt-sm-0 ms-sm-auto ms-md-0">
                <div class="w-56 position-relative text-gray-700 dark-text-gray-300">
                    <input type="text" class="form-control w-56 box border-white dark-border-dark-3 pe-10 placeholder-theme-13" placeholder="Tìm kiếm...">
        ...
        <div class="intro-y g-col-12 overflow-auto overflow-lg-visible">
            <table class="table table-report mt-n2">
                ...
                <tbody>
                    <tr ng-cloak dir-paginate="product in products | itemsPerPage:pageSize" current-page="currentPage" class="intro-x">
                        ...
                        <td class="w-40">
                            ...
                            @{{ product.is_active == 1 ? 'text-theme-9' : 'text-theme-6'}}">
                                ...
                                @{{ product.is_active == 1 ? 'Hoạt động' : 'Ẩn'}}
                            </div>
                        </td>
                        ...
                        <div class="collapse" id="collapseColor">
                            <div class="card card-body" style="background: #f1f5f8;">
                                <div style="background: #fff;" class="grid columns-12 gap-4 gap-y-3 w-full p-5">
                                    ...
                                    <div class="g-col-12 g-col-sm-4">
                                        <select ng-model="color.is_active" class="form-select w-full">
                                            <option style="display:none" value="">Chọn trạng thái</option>
                                            <option value="1" 
                                            ng-selected="color.is_active == 1">
                                                Hoạt động
                                            </option>
                                            <option value="0" 
                                            ng-selected="color.is_active == 0">
                                                Ẩn
                                            </option>
                                        </select>
                                    </div>
                                ...
                                <table class="table table-report mt-n2 table__colors">
                                    ...
                                    <tbody>
                                        <tr ng-cloak ng-repeat="color in colors" ng-click="getColor(color.id, $event)" class="intro-x">
                                            <td class="text-wrap w-full">@{{ color.color_name }}</td>
                                            <td class="text-center w-20">
                                                <div class="table__colors-color"
                                                ng-style="{ 'background': color.hex }"
                                                ></div>
                                            </td>
                                            <td class="text-center w-20">@{{ (color.price.price | currency:"":0) || "(chưa có giá)" }}</td>
                                            <td class="text-center w-20">
                                                <div class="d-flex align-items-center justify-content-center
                                                @{{ color.is_active == 1 ? 'text-theme-9' : 'text-theme-6'}}">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check-square w-4 h-4 me-2"><polyline points="9 11 12 14 22 4"></polyline><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"></path></svg>
                                                    <!-- @{{ color.is_active == 1 ? 'Hoạt động' : 'Ẩn'}} -->
                                                </div>
                                            </td>
                        ...
                        <div class="collapse" id="collapseProduct">
                            <div class="card card-body" style="background: #f1f5f8;">
                                <div style="background: #fff;" class="grid columns-12 gap-4 gap-y-3 w-full p-5">
                                    ...
                                    <div class="g-col-12">
                                        <label for="modal-form-5" class="form-label">Trạng thái (Hoạt động / Ẩn)</label>
                                        <div class="mt-2">
                                            <select ng-model="product.is_active" class="form-select w-full">
                                                <option style="display:none" value="">Chọn trạng thái</option>
                                                <option ng-selected="product.is_active == 1"
                                                ng-value="1">
                                                    Hoạt động
                                                </option>
                                                <option ng-selected="product.is_active == 0"
                                                ng-value="0">
                                                    Ẩn
                                                </option>
                                            </select>
    ...
    <div id="color-modal" class="modal fade" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-body grid columns-12 gap-4 gap-y-3 p-10 text-center">
                    <!-- price -->
                    <div class="g-col-6">
                        <button class="btn btn-secondary btn__manage w-full me-1 mb-2"
                            ...
                            <div class="card card-body" style="background: #f1f5f8;">
                                <div style="background: #fff;" class="grid columns-12 gap-4 gap-y-3 w-full p-5">
                                    ...
                                    <div class="g-col-12 g-col-sm-5">
                                        <select ng-model="size.is_active" class="form-select w-full">
                                            <option style="display:none" value="">Chọn trạng thái</option>
                                            <option value="1" 
                                            ng-selected="size.is_active == 1">
                                                Hoạt động
                                            </option>
                                            <option value="0" 
                                            ng-selected="size.is_active == 0">
                                                Ẩn
                                            </option>
                                        </select>
                                    </div>
                                ...
                                <table class="table table-report mt-n2 table__colors">
                                    ...
                                    <tbody>
                                        <tr ng-cloak ng-repeat="size in sizes" ng-click="getSize(size.id, $event)" class="intro-x">
                                            <td class="text-wrap w-full">@{{ size.size_name }}</td>
                                            <td class="text-center w-40">@{{ size.quantity }}</td>
                                            <td class="text-center w-56">
                                                <div class="d-flex align-items-center justify-content-center
                                                @{{ size.is_active == 1 ? 'text-theme-9' : 'text-theme-6'}}">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check-square w-4 h-4 me-2"><polyline points="9 11 12 14 22 4"></polyline><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"></path></svg>
                                                    <!-- @{{ color.is_active == 1 ? 'Hoạt động' : 'Ẩn'}} -->
                                                </div>
                                            </td>
                    ...
                    <div class="g-col-6">
                        ...
                        <div class="collapse show" id="collapseImage">
                            <div class="card card-body" style="background: #f1f5f8;">
                                <div style="background: #fff;" class="grid columns-12 gap-4 gap-y-3 w-full p-5">
                                    <div class="g-col-12">
                                        <img src="/uploads/products/1/g63.jpg" data-action="zoom" style="object-fit: cover" class="w-full rounded-2" alt="">
                                    </div>
                                    <div class="g-col-12">
                                        <input type="file" class="form-control" ng-model="product.size_table">
                                    </div>
                                    <div class="g-col-12">
                                        <select ng-model="color.is_active" class="form-select w-full">
                                            <option style="display:none" value="">Chọn trạng thái</option>
                                ...
                                <table class="table table-report mt-n2 table__colors">
                                    <thead>
                                        <tr>
                                            <th class="text-wrap">Hình ảnh</th>
                                            <th class="text-center text-nowrap">Hành động</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr ng-repeat="color in colors" ng-click="getColor(color.id, $event)" class="intro-x">
                                            <td class="text-wrap w-full">@{{ color.color_name }}</td>
                                            <td class="text-center w-20">
                                                <div class="table__colors-color"
                                                ng-style="{ 'background': color.hex }"
                                            ...
                                            <td class="text-center w-20">@{{ color.price || "(chưa có giá)" }}</td>
                                            <td class="text-center w-20">
                                                <div class="d-flex align-items-center justify-content-center
                                                @{{ color.is_active == 1 ? 'text-theme-9' : 'text-theme-6'}}">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check-square w-4 h-4 me-2"><polyline points="9 11 12 14 22 4"></polyline><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"></path></svg>
