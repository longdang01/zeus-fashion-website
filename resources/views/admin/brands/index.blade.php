...
<div ng-controller="BrandController">
    ...
    <div class="grid columns-12 gap-6 mt-5">
        <div class="intro-y g-col-12 d-flex flex-wrap flex-sm-nowrap align-items-center mt-2">
            ...
            data-bs-target="#save-modal-brand"
            ng-click="getBrand(0)"
            ...
            <div class="d-none d-md-block mx-auto text-gray-600">Hiển thị <span ng-cloak>@{{ pageSize }}</span> / <span ng-cloak>@{{ brands.length }}</span> thương hiệu</div>
            ...
            <table class="table table-report mt-n2">
                <thead>
                    <tr>
                        ...
                        <th class="text-wrap">Tên thương hiệu</th>
                        <th class="text-center text-nowrap">Hành động</th>
                    </tr>
                </thead>
                <tbody>
                    <tr ng-cloak dir-paginate="brand in brands | itemsPerPage:pageSize | filter: { brand_name: keySearch } track by $index" current-page="currentPage" class="intro-x">
    ...
    <!-- BEGIN: Brand  -->
    <div id="save-modal-brand" class="modal fade" tabindex="-1" aria-hidden="true">
                            ...
                            <div class="collapse" id="collapseBrand">
                                <div class="card card-body" style="background: #f1f5f8;">
                                    <div style="background: #fff;" class="grid columns-12 gap-4 gap-y-3 w-full p-5">
                                        <div class="g-col-12">
                                            <label for="modal-form-1" class="form-label">Tên thương hiệu</label>
                                            <input id="modal-form-1" type="text" class="form-control"
                                            placeholder="Zeus, Dior" 
                                            ng-model="brand.brand_name">
                                        </div>
                                        <div class="g-col-12">
                                            <label for="modal-form-5" class="form-label">Mô tả thương hiệu</label>
                                            <div class="mt-2">
                                                <div
                                                    ckeditor="options"
