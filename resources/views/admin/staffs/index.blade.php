...
<div ng-controller="StaffController">
    ...
    <div class="grid columns-12 gap-6 mt-5">
        <div class="intro-y g-col-12 d-flex flex-wrap flex-sm-nowrap align-items-center mt-2">
            ...
            data-bs-target="#save-modal-staff"
            ng-click="getStaff(0)"
            ...
            <div class="d-none d-md-block mx-auto text-gray-600">Hiển thị <span ng-cloak>@{{ pageSize }}</span> / <span ng-cloak>@{{ staffs.length }}</span> nhân viên</div>
            ...
            <table class="table table-report mt-n2">
                <thead>
                    <tr>
                        ...
                        <th class="text-wrap">Tên nhân viên</th>
                        <th class="text-center text-nowrap">Vai trò</th>
                        <th class="text-center text-nowrap">Vị trí</th>
                ...
                <tbody>
                    <tr ng-cloak dir-paginate="staff in staffs | itemsPerPage:pageSize | filter: { staff_name: keySearch } track by $index" current-page="currentPage" class="intro-x">
                        <td class="text-center w-20">@{{ $index + currentPage * 10 - 9 }}</td>
                        <td class="text-start">@{{ staff.staff_name }}</td>
                        <td class="text-center">@{{ staff.position.role.role_name }}</td>
    ...
    <!-- BEGIN: Brand  -->
    <div id="save-modal-staff" class="modal fade" tabindex="-1" aria-hidden="true">
                                ...
                                <div class="card card-body" style="background: #f1f5f8;">
                                    <div style="background: #fff;" class="grid columns-12 gap-4 gap-y-3 w-full p-5">
                                        <div class="g-col-12 g-col-sm-6">
                                            ...
                                            placeholder="Abc, Xyz" 
                                            ng-model="staff.users.username"> 
                                        </div>
                                        <div class="g-col-12 g-col-sm-6">
                                            <label for="modal-form-1" class="form-label">Mật khẩu</label>
                                            <input id="password" type="text" class="form-control"
                                            placeholder="Abc, Xyz" 
                                            ng-model="staff.users.password">
                                        </div>
                                        <div class="g-col-12 g-col-sm-6">
                                            <label for="modal-form-1" class="form-label">Tên nhân viên</label>
                                            <input id="modal-form-1" type="text" class="form-control"
                                            placeholder="Abc, Xyz" 
                                            ng-model="staff.staff_name">
                                        </div>
                                        <div class="g-col-12 g-col-sm-6">
                                            <label for="modal-form-1" class="form-label">Ngày sinh</label>
                                            <input id="dobStaff" type="date" class="form-control"
                                            ng-model="staff.dob" date-format>
                                        </div>
                                        <div class="g-col-12 g-col-sm-6">
                                            <label for="modal-form-1" class="form-label">Vai trò</label>
                                            <select class="form-select w-full"
                                                ng-model="staff.position.role_id"
                                                ng-change="changeRole()"
                                                >
                                                    <option style="display:none" value="">Chọn vai trò</option>
                                                    <option
                                                    ng-repeat="role in roles"
                                                    ng-selected="staff.staff.position.role_id == role.id"
                                                    ng-value="role.id">@{{ role.role_name }}</option>
                                            </select>
                                        </div>
                                        <div class="g-col-12 g-col-sm-6">
                                            <label for="modal-form-1" class="form-label">Vị trí</label>
                                            <select class="form-select w-full"
                                                ng-model="staff.position_id"
                                                >
                                                    <option style="display:none" value="">Chọn vị trí</option>
                                                    <option
                                                    ng-repeat="position in positions"
                                                    ng-selected="staff.position_id == position.id"
                                                    ng-value="position.id">@{{ position.position_name }}</option>
                                            </select>
                                        </div>
                                        <div class="g-col-12">
                                        ...
                                        <div class="g-col-12 g-col-sm-6">
                                            ...
                                            <input id="modal-form-1" type="text" class="form-control"
                                            placeholder="0938182xxx, 0392293xxx" 
                                            ng-model="staff.phone">
                                        </div>
                                        <div class="g-col-12 g-col-sm-6">
                                            <label for="modal-form-1" class="form-label">Email</label>
                                            <input id="modal-form-1" type="text" class="form-control"
                                            placeholder="david@gmail.com, jessica@gmail.com" 
                                            ng-model="staff.email">
                                        </div>
                                        <div class="g-col-12">
                                            <label for="modal-form-5" class="form-label">Ảnh đại diện</label>
                                            <div class="mt-2">
                                                <input id="picture-upload" type="file" class="form-control mb-2" ng-model="staff.picture">
                                                <img id="picture-image" data-action="zoom" style="object-fit: cover" class="w-full rounded-2">
