...
<div ng-controller="CategoryController">
    ...
    <div class="grid columns-12 gap-6 mt-5">
        <div class="intro-y g-col-12 d-flex flex-wrap flex-sm-nowrap align-items-center mt-2">
            ...
            data-bs-target="#save-modal-category"
            ng-click="getCategory(0)"
            ...
            <div class="d-none d-md-block mx-auto text-gray-600">Hiển thị <span ng-cloak>@{{ pageSize }}</span> / <span ng-cloak>@{{ categories.length }}</span> danh mục</div>
            ...
            <table class="table table-report mt-n2">
                <thead>
                    <tr>
                        ...
                        <th class="text-wrap">Tên danh mục</th>
                        <th class="text-center text-nowrap">Hành động</th>
                    </tr>
                </thead>
                <tbody>
                    <tr ng-cloak dir-paginate="category in categories | itemsPerPage:pageSize | filter: { category_name: keySearch } track by $index" current-page="currentPage" class="intro-x">
                        ...
                        <td class="table-report__action w-40">
                            <div class="d-flex justify-content-center align-items-center">
                                ...
                                ng-click="getCategory(category.id)"
                                >
                                ...
                                href="javascript:;"
                                ng-click="getCategory(category.id, -1);"
                                >
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
    ...
    <!-- BEGIN: Modal Content -->
    <!-- BEGIN: Category  -->
    <div id="save-modal-category" class="modal fade" tabindex="-1" aria-hidden="true">
                                ...
                                <div class="card card-body" style="background: #f1f5f8;">
                                    <div style="background: #fff;" class="grid columns-12 gap-4 gap-y-3 w-full p-5">
                                        <div class="g-col-12">
                                            ...
                                            placeholder="Áo phông, Quần Jeans"
                                            ng-model="subCategory.sub_category_name">
                                        </div>
                                        
                                        <div class="g-col-12">
                                            <div 
                                                ckeditor="options"
                                                ng-model="subCategory.description"
                                            ></div>
                                        </div>
                                        <div class="g-col-12 d-flex justify-content-start">
                                            <button class="btn btn-secondary btn__manage btn__create-subCategory me-1 mb-2"
                                            ng-click="addSubCategory()"
                                            >
                                                Thêm
                                            </button>
                                            <button class="btn btn-secondary btn__manage btn__update-subCategory me-1 mb-2"
                                            ng-click="updateSubCategory()"
                                            >
                                                Cập nhật
                                            </button>
                                            <button class="btn btn-secondary btn__manage btn__reset-subCategory me-1 mb-2"
                                            ng-click="actionSubCategory(0)">
                                                Làm mới
                                            </button>
                                        </div>
                                    </div>
                                    <table class="table table-report mt-n2 table__colors">
                                        <thead>
                                            <tr>
                                                <th class="text-wrap">Tên danh mục con</th>
                                                <th class="text-center text-nowrap">Hành động</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr ng-cloak ng-repeat="subCategory in category.sub_categories track by $index"
                                             ng-click="getSubCategory(subCategory.id, $event, 1)" class="intro-x">
                                                <td class="text-wrap">@{{ subCategory.sub_category_name }}</td>
                                                <td class="table-report__action w-20">
                                                    <div class="d-flex justify-content-center align-items-center">
                                                        <a class="d-flex align-items-center text-theme-6"
                                                        href="javascript:;"
                                                        ng-click="getSubCategory(subCategory.id, $event, -1)"
                                                        >
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                            viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                            stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <div class="g-col-12">
                            ...
                            <div class="collapse" id="collapseCategory">
                                <div class="card card-body" style="background: #f1f5f8;">
                                    <div style="background: #fff;" class="grid columns-12 gap-4 gap-y-3 w-full p-5">
                                        <div class="g-col-12">
                                            <label for="modal-form-1" class="form-label">Tên danh mục</label>
                                            <input id="modal-form-1" type="text" class="form-control" 
                                            placeholder="Áo, Quần" 
                                            ng-model="category.category_name">
                                        </div>
                                        <div class="g-col-12">
                                            <label for="modal-form-2" class="form-label">Mô tả</label>
                                            <div
                                                ckeditor="options"
    ...
    <!-- BEGIN: Success  -->
    <div style="display: none" id="subCategory-modal-description" class="modal fade" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body p-0">
                    <div 
