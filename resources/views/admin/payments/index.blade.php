...
<div ng-controller="PaymentController">
    ...
    <div class="grid columns-12 gap-6 mt-5">
        <div class="intro-y g-col-12 d-flex flex-wrap flex-sm-nowrap align-items-center mt-2">
            ...
            data-bs-target="#save-modal-payment"
            ng-click="getPayment(0)"
            >Thêm hình thức thanh toán</button>
            ...
            <div class="d-none d-md-block mx-auto text-gray-600">Hiển thị <span ng-cloak>@{{ pageSize }}</span> / <span ng-cloak>@{{ payments.length }}</span> hình thức thanh toán</div>
            ...
            <table class="table table-report mt-n2">
                <thead>
                    <tr>
                        ...
                        <th class="text-wrap">Hình thức thanh toán</th>
                        <th class="text-center text-nowrap">Hành động</th>
                    </tr>
                </thead>
                <tbody>
                    <tr ng-cloak dir-paginate="payment in payments | itemsPerPage:pageSize | filter: { payment_type: keySearch } track by $index" current-page="currentPage" class="intro-x">
                        <td class="text-center w-20">@{{ $index + currentPage * 10 - 9 }}</td>
                        <td class="text-start">@{{ payment.payment_type }}</td>
                        <td class="table-report__action w-40">
                            <div class="d-flex justify-content-center align-items-center">
                                <a class="d-flex align-items-center me-3" href="javascript:;"
                                ng-click="getPayment(payment.id)"
                                >
                                ...
                                href="javascript:;"
                                ng-click="getPayment(payment.id, -1);"
                                >
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
    ...
    <!-- BEGIN: Brand  -->
    <div id="save-modal-payment" class="modal fade" tabindex="-1" aria-hidden="true">
                            ...
                            <div class="collapse" id="collapsePayment">
                                <div class="card card-body" style="background: #f1f5f8;">
                                    <div style="background: #fff;" class="grid columns-12 gap-4 gap-y-3 w-full p-5">
                                        <div class="g-col-12">
                                            <label for="modal-form-1" class="form-label">Hình thức thanh toán</label>
                                            <input id="modal-form-1" type="text" class="form-control"
                                            placeholder="Thanh toán khi nhận hàng, Thanh toán bằng thẻ" 
